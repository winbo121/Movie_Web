...
$.ajax({
	...
	type:"get",
	url:"https://api.themoviedb.org/3/movie/upcoming?api_key=9ad6e90979035c5eda25f7a40305c3dd&language=ko-KR",
	dataType:"json",
	data:JSON.stringify({
      ...
      $.ajax({
				...
				success:function(result){
					...
					$(this.results[0]).each(function () {
						...
						var trailer = $("<div>").html("<iframe src='https://www.youtube.com/embed/"
								+key+"' frameborder='0' framespacing='0' marginheight='0' marginwidth='0'></iframe>").addClass("movie__Trailer");
						div.append(trailer);
...
$(window).scroll(function() {
    ...
    if ($(window).scrollTop() == $(document).height() - $(window).height()) {
    	$.ajax({
    		...
    		type:"get",
			url:"https://api.themoviedb.org/3/movie/upcoming?api_key=9ad6e90979035c5eda25f7a40305c3dd&language=ko-KR&page="+(page++),
			dataType:"json",
			data:JSON.stringify({
